...
def ask():
    try:
        ...
        2. النقل والنسخ: انقل النصوص المرجعية 'حرفياً وبالكامل' دون أي تلخيص أو حذف للجمل الطويلة. استخدم روابط لغوية ذكية للربط بين هذه النصوص (مثل: كما يشير في موضع آخر، علاوة على ذلك يقرر..) ليس دائما هذه الراوبط .
